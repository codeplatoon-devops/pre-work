...
We expect you to both be responsive and organized in communicating with Code Platoon and to complete a course of pre-work material on your own to prove to us you possess a solid foundation of knowledge and self-reliance we can build upon in the full time course.

### Responsiveness and organization

* Be responsive on [Slack](https://slack.com/) and via email. Slack is our preferred form of communication so [download](https://slack.com/downloads) it on your computer and/or on your phone. Use it to communicate with each other separately, not just for ‘public’ announcements.
...
* Pass the AWS Cloud Practitioner Certification Exam and share the results with us.
